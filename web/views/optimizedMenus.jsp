<!-- OPTIMIZED MENU PAGE :
     This page allows the user to select a menu optimized according to the budget he inserted .
     The application shows 4 menus :  in the first menu the starter is more important, in the second the biggest
     importance is given to first courses, in the third it is given to the main courses. The last menu has dishes with the
     same importance ( the more important the dish is, the more expensive it is ). The user can select one of these menus
